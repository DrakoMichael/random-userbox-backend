...
//   shell.exec(
//     "rimraf openapi.json && swagger-cli bundle openapi.yml -o openapi.json -f"
//   );

//   // compile ormconfig into js file
//   shell.exec(
//     "rimraf ormconfig.js && bunchee src/configs/config.database.ts -o ./ormconfig.js -f umd --target node --no-sourcemap"
//   );
...
// basicamente um script para compilar e copiar arquivos ou executar comandos
